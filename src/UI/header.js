...
export default function Example() {
  return (
    <Disclosure as="nav" className="bg-backColor">
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          <div className="absolute inset-y-0 left-0 flex items-cente-r sm:hidden">
            {/* Mobile menu button*/}
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            <div className="flex shrink-0 items-center">
                {/* Icon */}
                <img className="h-8 w-auto" src={icon} alt="header_icon"></img>
                <div className="text-white font-[Giants-Regular] pl-[10px]">SPORTS HOLIC</div>
            </div>
                ...
                {navigation.map((item) => (
                  <a
                    ...
                    className={classNames(
                      item.current ? 'bg-gray-900 text-white' : 'text-gray-00 hover:bg-gray-700 hover:text-white',
